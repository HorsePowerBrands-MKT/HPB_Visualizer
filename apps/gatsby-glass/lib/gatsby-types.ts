/**
 * Gatsby Glass brand-specific types
 *
 * These types define the product catalog, configuration options, and payload
 * structures that are unique to the Gatsby Glass shower-glass business.
 * Other brands (fencing, blinds, painting, etc.) will define their own
 * equivalent types in their respective apps.
 */

// Design mode types (shared concept, but values may differ per brand)
