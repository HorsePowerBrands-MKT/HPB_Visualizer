/**
 * Gatsby Glass Visualizer State Hook
 *
 * Brand-specific state management for the shower glass visualization wizard.
 * Contains Gatsby Glass product defaults, step flow, and business logic
 * (e.g. neo-angle compatibility rules).
 *
 * Other brands will create their own equivalent hook with their product
 * defaults and wizard flow.
 */
