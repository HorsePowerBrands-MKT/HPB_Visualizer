 ...
 * Each brand defines its own set of templates describing its products and
 * AI visualization requirements.
 *
 * To edit how the AI generates visualizations, modify the template sections below.
 */
...
export const gatsbyGlassRegistry: PromptTemplateRegistry = {
  ...
  templates: {
    "visualization-v2": { path: "./visualization-v2.json", version: "2.0.0", active: true },
...
export const gatsbyGlassTemplates: Record<string, PromptTemplate> = {
  'visualization-v2': visualizationTemplate,
